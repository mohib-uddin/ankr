...
export type SignupPathName = keyof typeof paths;

type PathProps = { name: SignupPathName } & SVGProps<SVGPathElement>;
...
/** Chevron used on the signup submit button (Figma) */
export function SignupSubmitChevronIcon() {
  return (
