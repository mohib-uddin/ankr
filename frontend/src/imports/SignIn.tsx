import svgPaths from "./svg-k6r8xjg2uf";

function Frame12() {
  return (
    <div className="content-stretch flex flex-col gap-[12px] items-start relative shrink-0 w-full">
      <div className="font-['Cormorant_Garamond',sans-serif] leading-[50px] not-italic relative shrink-0 text-[#3e2d1d] text-[48px] w-full">
        <p className="mb-0">Build Your</p>
        <p>Financial Profile</p>
      </div>
      <p className="font-['SF_Pro',sans-serif] font-[510] leading-[normal] relative shrink-0 text-[#764d2f] text-[16px] w-full" style={{ fontVariationSettings: "'wdth' 100" }}>
...
function Frame() {
  return (
    <div className="content-stretch flex flex-col gap-[64px] items-center relative shrink-0 text-center w-full">
      <p className="font-['Cormorant_Garamond',sans-serif] leading-[71.822px] not-italic relative shrink-0 text-[#3e2d1d] text-[72px] tracking-[2.88px] whitespace-nowrap">ANKR</p>
      <Frame12 />
    </div>
  );
}
...
function Frame2() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start leading-[normal] relative shrink-0 w-full">
      <p className="font-['Canela_Text_Trial',sans-serif] not-italic relative shrink-0 text-[#3e2d1d] text-[24px] w-full">Upload Existing PFS</p>
  ...
  return (
    <div className="relative shrink-0 size-[40px]" data-name="mynaui:upload">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 40 40">
        <g id="mynaui:upload">
          <rect fill="var(--fill-0, #895D40)" height="40" rx="5.19481" width="40" />
...
function Frame5() {
  return (
    <div className="bg-[#3e2d1d] relative rounded-[16px] shrink-0">
    ...
    <div className="absolute bg-white bottom-[36px] content-stretch flex gap-[10px] items-center justify-center left-[calc(26.67%+76.3px)] px-[24px] py-[10px] rounded-[100px]">
      ...
      <div className="relative shrink-0 size-[9px]">
        <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 9 9">
          <circle cx="4.5" cy="4.5" fill="var(--fill-0, #3E2D1D)" id="Ellipse 2" r="4.5" />
        </svg>
      </div>
...
export default function SignIn() {
  return (
    <div className="bg-gradient-to-b from-[#fcf5ed] relative size-full to-[#ded0c3] to-[160.46%]" data-name="Sign In">
      <Frame9 />
      <Frame11 />
    </div>
  );
