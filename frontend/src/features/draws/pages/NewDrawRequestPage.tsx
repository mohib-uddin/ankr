...
import { useApp, getDrawnForCategory, formatCurrency, genId, DOCUMENT_PACKAGES } from '@/app/context/AppContext';
import type { DrawLineItem, DrawAttachment, DocumentPackageId } from '@/app/context/AppContext';
